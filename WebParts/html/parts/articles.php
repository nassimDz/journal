...
//cette page nous affiche tout les articles qui sont validé, un article est affiché si est seulement si'il est validé par l'admin
...
$sql_get_article = 'SELECT * FROM article WHERE statue=?';
$prepared_get_article = $db->prepare($sql_get_article);

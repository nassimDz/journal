<?php
//cette page sert a modifié un article donnée, par son identificateur, on le récupère depuis la BDD
//, on l'affiche dans le formulaire de modification

//on accède a cette page si est seuelment si on est connecté
if(!isAuthenticated()){
...
//aprés avoir modifier notre article, on fait les modifications au niveau de la BDD
if(!empty($_POST)){
  extract($_POST);

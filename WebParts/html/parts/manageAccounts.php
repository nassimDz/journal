    ...
    <thead>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td><?php if($user->statut !="admin"){ ?><a href="index.php?path=editRole&amp;to=admin&amp;id=<?php echo $user->ID; ?>">Affecter le rôle d'administrateur</a> / <?php } ?><a href="index.php?path=removeuser&amp;id=<?php echo $user->ID; ?>">Supprimer</a></td>
       </tr>
        <?php } ?>
      </tbody>
    </table>

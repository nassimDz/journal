...
// d'abbord, on récupère la catégorie depuis la BDD en utilisant son identificateur
if(isset($_REQUEST)){
  $id = $_REQUEST['id'];
...
//aprés avoir remplis le formulaire de modif, on fait la modif au niveau de la BDD
if(!empty($_POST)){
  extract($_POST);
